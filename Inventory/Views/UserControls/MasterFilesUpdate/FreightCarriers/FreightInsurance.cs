    ...
    public partial class FreightInsurance : UserControl, IActiveControlManager
    {
            ...
            if (freightData != null)
            {
                if (IsDataModified(freightData))
                {
                    ...
                    if (existingFreightData != null)
                    {
                        ...
                        existingFreightData.GEN_BEG = string.IsNullOrEmpty(genBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genBeg) ? genBeg : DateTime.MinValue;
                        existingFreightData.GEN_END = string.IsNullOrEmpty(genEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genEnd) ? genEnd : DateTime.MinValue;
                        existingFreightData.GEN_LET = string.IsNullOrEmpty(genLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genLetter) ? genLetter : DateTime.MinValue;
                        ...
                        existingFreightData.AUTO_BEG = string.IsNullOrEmpty(autoBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoBeg) ? autoBeg : DateTime.MinValue;
                        existingFreightData.AUTO_END = string.IsNullOrEmpty(autoEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoEnd) ? autoEnd : DateTime.MinValue;
                        existingFreightData.AUTO_LET = string.IsNullOrEmpty(autoLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoLetter) ? autoLetter : DateTime.MinValue;
                        ...
                        existingFreightData.WORK_BEG = string.IsNullOrEmpty(compBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compBeg) ? compBeg : DateTime.MinValue;
                        existingFreightData.WORK_END = string.IsNullOrEmpty(compEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compEnd) ? compEnd : DateTime.MinValue;
                        existingFreightData.WORK_LET = string.IsNullOrEmpty(compLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compLetter) ? compLetter : DateTime.MinValue;
                        ...
                        existingFreightData.CARGO_BEG = string.IsNullOrEmpty(cargoBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoBeg) ? cargoBeg : DateTime.MinValue;
                        existingFreightData.CARGO_END = string.IsNullOrEmpty(cargoEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoEnd) ? cargoEnd : DateTime.MinValue;
                        existingFreightData.CARGO_LET = string.IsNullOrEmpty(cargoLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoLetter) ? cargoLetter : DateTime.MinValue;
                        ...
                        existingFreightData.PHY_BEG = string.IsNullOrEmpty(damageBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(damageBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var damageBeg) ? damageBeg : DateTime.MinValue;
                        existingFreightData.PHY_END = string.IsNullOrEmpty(damageEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(damageEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var damageEnd) ? damageEnd : DateTime.MinValue;
        ...
        private bool IsDataModified(freight freightData)
        {
            return freightData == null || freightData.INS_TP1 != insTp1TextBox.Text.Trim() ||
                ...
                freightData.GEN_BEG != (string.IsNullOrEmpty(genBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genBeg) ? genBeg : DateTime.MinValue) ||
                freightData.GEN_END != (string.IsNullOrEmpty(genEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genEnd) ? genEnd : DateTime.MinValue) ||
                freightData.GEN_LET != (string.IsNullOrEmpty(genLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(genLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var genLetter) ? genLetter : DateTime.MinValue) ||
                ...
                freightData.AUTO_BEG != (string.IsNullOrEmpty(autoBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoBeg) ? autoBeg : DateTime.MinValue) ||
                freightData.AUTO_END != (string.IsNullOrEmpty(autoEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoEnd) ? autoEnd : DateTime.MinValue) ||
                freightData.AUTO_LET != (string.IsNullOrEmpty(autoLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(autoLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var autoLetter) ? autoLetter : DateTime.MinValue) ||
                ...
                freightData.WORK_BEG != (string.IsNullOrEmpty(compBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compBeg) ? compBeg : DateTime.MinValue) ||
                freightData.WORK_END != (string.IsNullOrEmpty(compEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compEnd) ? compEnd : DateTime.MinValue) ||
                freightData.WORK_LET != (string.IsNullOrEmpty(compLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(compLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var compLetter) ? compLetter : DateTime.MinValue) ||
                ...
                freightData.CARGO_BEG != (string.IsNullOrEmpty(cargoBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoBeg) ? cargoBeg : DateTime.MinValue) ||
                freightData.CARGO_END != (string.IsNullOrEmpty(cargoEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoEnd) ? cargoEnd : DateTime.MinValue) ||
                freightData.CARGO_LET != (string.IsNullOrEmpty(cargoLetterSentDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(cargoLetterSentDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var cargoLetter) ? cargoLetter : DateTime.MinValue) ||
                ...
                freightData.PHY_BEG != (string.IsNullOrEmpty(damageBeginDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(damageBeginDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var damageBeg) ? damageBeg : DateTime.MinValue) ||
                freightData.PHY_END != (string.IsNullOrEmpty(damageEndDateMaskBox.Text.Trim()) ? null : DateTime.TryParse(damageEndDateMaskBox.Text.Trim(), new CultureInfo("en-US"), DateTimeStyles.None, out var damageEnd) ? damageEnd : DateTime.MinValue) ||
